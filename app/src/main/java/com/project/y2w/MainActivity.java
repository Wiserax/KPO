...
import com.project.y2w.db.CalendarHandler;
import com.project.y2w.db.DataBaseHandler;
import com.project.y2w.home_page.BandAdapter;
import com.project.y2w.home_page.ListViewsElements.DaysMode.DaysViewAdapter;
import com.project.y2w.home_page.ListViewsElements.WeeksMode.WeeksTaskStruct;
import com.project.y2w.home_page.ListViewsElements.WeeksMode.WeeksViewAdapter;
import com.project.y2w.home_page.ListViewsElements.WeeksMode.WeeksViewAssistantHome;
import com.project.y2w.home_page.SnapToBlock;
import com.project.y2w.home_page.tasks.AddTaskDialogFragment;
import com.project.y2w.home_page.tasks.ServiceRepeatable;
import com.project.y2w.settings.Settings;
import com.project.y2w.settings.SignInActivity;
import com.project.y2w.tasks_history.TasksHistory;
